...
void main(void) {
    ...
    vec3 lightDirection1 = normalize(lightPosition1 - v_position);
    ...
    vec3 lightDirection2 = normalize(lightPosition2 - v_position);
    ...
    vec3 lightDirection3 = normalize(lightPosition3 - v_position);
